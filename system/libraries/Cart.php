...
class CI_Cart {
     ...
     * Typically it is called from the "view cart" page if a employee makes
    ...
    function update($items = array()) {
        ...
        $save_cart = FALSE;
        if (isset($items['rowid']) AND isset($items['qty']) AND ! isset($items['price']) AND ! isset($items['price_option']) AND ! isset($items['tax'])) {
         ...
         */ elseif (isset($items['rowid']) AND isset($items['qty']) AND isset($items['price']) AND isset($items['price_option']) AND isset($items['tax'])) {
            if ($this->_update($items) == TRUE) {
                $save_cart = TRUE;
            }
        } else {
    ...
    function _update($items = array()) {
        ...
        if (($this->_cart_contents[$items['rowid']]['qty'] == $items['qty']) AND ( $this->_cart_contents[$items['rowid']]['price'] == $items['price']) AND ( $this->_cart_contents[$items['rowid']]['price_option'] == $items['price_option']) AND ( $this->_cart_contents[$items['rowid']]['tax'] == $items['tax'])) {
            return FALSE;
        }
        ...
        if (isset($items['price_option'])) {
            $this->_cart_contents[$items['rowid']]['price_option'] = $items['price_option'];
        }
        if ((isset($items['tax']) AND is_float($items['tax'])) || (isset($items['tax']) AND is_numeric($items['tax']))) {
            $this->_cart_contents[$items['rowid']]['tax'] = $items['tax'];
        }
