 ...
 */
$config['site_title']           = "Stock Manager Advance"; 		// Site Title, example.com
$config['admin_email']          = "noreply@stockmanager.us"; 	// Admin Email, admin@example.com
$config['default_group']        = 'viewer'; 			// Default group, use name
$config['admin_group']          = 'owner'; 				// Default administrators group, use name
