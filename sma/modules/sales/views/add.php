...
<?php } ?>
        ...
        $('#code').keydown(function(e) {
            ...
            if (e.keyCode == 13) {
                ...
                newTr.html('<td><input name="product' + count + '" type="hidden" value="' + item_code + '"><input class="span5 tran" name="item' + count + '" type="text" value="' + item_name + ' (' + item_code + ')"></td><?php
if (PRODUCT_SERIAL) {
...
<?php if (DISCOUNT_METHOD == 1 && DISCOUNT_OPTION == 1) { ?>
                                    ...
                                    if (discount_type == 1) {
                                        total_discount = ((total+total_tax1) * discount) / 100;
                                    }
...
<?php if (TAX2) { ?>
                                    ...
                                    if (tax_type2 == 1) {
                                        total_tax2 = ((total+total_tax1-total_discount) * tax_rate2) / 100;
                                    }
				    
<?php } ?>
				    
<?php if (DISCOUNT_METHOD == 2 && DISCOUNT_OPTION == 1) { ?>
                                    if (discount_type == 2) {
                                        total_discount = discount;
                                    }
                                    if (discount_type == 1) {
...
<?php if (TAX2) { ?>
 ...
 <?php if (DISCOUNT_OPTION == 1 && DISCOUNT_METHOD == 1) { ?> 
				ds1_v = $('#discount_s').val();
				if(ds1_v) {
				$.each(discounts, function() {
                                    if (this.id == ds1_v) {
                                        new_discount_rate = parseFloat(this.discount);
				...
				if (new_discount_type == 2) {
                                ...
                                if (new_discount_type == 1) {
                                    total_discount = ((total + total_tax1) * new_discount_rate) / 100;
                                }
...
<?php } ?>
                                ...
                                if (new_tax_type == 1) {
                                    new_tax_rate = ((total+total_tax1-total_discount) * new_tax_rate) / 100;
                                }
                                if (old_tax_type == 2) {
                                    old_tax_rate = old_tax_rate;
                                }
                                if (old_tax_type == 1) {
                                    old_tax_rate = ((total+total_tax1-total_discount) * old_tax_rate) / 100;
                                }
...
<?php if (DISCOUNT_OPTION == 1) { ?>
    ...
    <?php if (DISCOUNT_METHOD == 1) { ?>
                                    ...
                                    if (new_discount_type == 1) {
                                        new_discount = ((total+total_tax1) * new_discount_rate) / 100;
                                    }
                                    if (old_discount_type == 2) {
                                        old_discount = old_discount_rate;
                                    }
                                    if (old_discount_type == 1) {
                                        old_discount = ((total+total_tax1) * old_discount_rate) / 100;
                                    }
				...
				if (new_tax_type == 2) {
                                ...
                                if (new_tax_type == 1) {
                                    total_tax2 = ((total+total_tax1-total_discount) * new_tax_rate) / 100;
                                }
				$('#ttax2').val(total_tax2.toFixed(2));
				}
...
<?php if (DISCOUNT_OPTION == 2 && DISCOUNT_METHOD == 1) { ?>
                                    ...
                                    rdiscount = ((row_price) * new_discount_rate) / 100;
				    //total_discount += rdiscount;
                                    //$('#tds').val(total_discount.toFixed(2));
				    $.each(tax_rates, function() {
                                    if (this.id == ntval) {
                                        new_tax_rate = parseFloat(this.rate);
                                ...
                                if (new_tax_type == 1) {
                                    new_pr_tax_rate = ((row_price-rdiscount) * new_tax_rate) / 100;
                                }
                                if (old_tax_type == 2) {
                                    old_pr_tax_rate = old_tax_rate;
                                }
                                if (old_tax_type == 1) {
                                    old_pr_tax_rate = ((row_price-rdiscount) * old_tax_rate) / 100;
                                }
...
<?php } ?>
	...
	<?php if (TAX2 && DISCOUNT_OPTION == 2 && DISCOUNT_METHOD == 1) { ?>
	    var invt = $('#tax2_s').val();
	    $.each(tax_rates, function() {
                                    if (this.id == invt) {
                                        new_tax_rate = parseFloat(this.rate);
				...
				if (new_tax_type == 2) {
                                    tax_rate2 = new_tax_rate;
                                }
			
                                if (new_tax_type == 1) {
                                    tax_rate2 = ((total + total_tax1 - total_discount) * new_tax_rate) / 100;
                                }
				$('#ttax2').val(Math.abs(tax_rate2).toFixed(2));
...
<?php if (TAX1) { ?>
                                ...
                                if (new_tax_type == 1) {
                                    opr_tax_rate = ((oldrowtotal-opr_discount_rate) * new_tax_rate) / 100;
                                }
                                if (new_tax_type == 2) {
                                    npr_tax_rate = new_tax_rate;
                                }
                                if (new_tax_type == 1) {
                                    npr_tax_rate = ((newrowtotal-npr_discount_rate) * new_tax_rate) / 100;
                                }
...
<?php if (DISCOUNT_OPTION == 1) { ?>
    ...
    <?php if (DISCOUNT_METHOD == 1) { ?>
                                    if (new_discount_type == 1) {
                                        new_discount_rate = ((total+total_tax1) * new_discount_rate) / 100;
                                    }
    <?php } ?>
...
<?php if (DISCOUNT_OPTION == 2) { ?>
	...
	<?php } ?>
		...
		var nt = $('#tax_rate-' + rw_no).val();
                                    ...
                                    if (new_tax_type == 1) {
                                        opr_tax = ((row_price-opr_discount) * new_tax_rate) / 100;
                                    } else {
					opr_tax = 0;
				    }
				    if (new_tax_type == 1) {
                                        npr_tax = ((row_price-npr_discount) * new_tax_rate) / 100;
                                    } else {
					npr_tax = 0;
				    }
    ...
    <?php if (DISCOUNT_METHOD == 2) { ?>
                                    ...
                                    if (old_discount_type == 1) {
                                        opr_discount = ((row_price + npr_tax) * old_discount_rate) / 100;
                                    }
                                    if (new_discount_type == 2) {
                                        npr_discount = new_discount_rate * quantity;
                                    }
                                    if (new_discount_type == 1) {
                                        npr_discount = ((row_price + npr_tax) * new_discount_rate) / 100;
                                    }
