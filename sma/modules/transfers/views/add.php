...
echo form_open("module=transfers&view=add", $attrib); ?>
...
<div class="control-group">
    ...
    <div class="controls">  <?php
        ...
        echo form_dropdown('from_warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ''), 'id="fwarehouse_s" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . ' (' . $this->lang->line("from") . ')" required="required" data-error="' . $this->lang->line("warehouse") . ' (' . $this->lang->line("from") . ') ' . $this->lang->line("is_required") . '"');
?> </div>
</div>
<div class="control-group">
    <label class="control-label" id="twarehouse_l"><?php echo $this->lang->line("to"); ?></label>
    <div class="controls">  <?php echo form_dropdown('to_warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ''), 'id="twarehouse_s" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . ' (' . $this->lang->line("to") . ')" required="required" data-error="' . $this->lang->line("warehouse") . ' (' . $this->lang->line("to") . ') ' . $this->lang->line("is_required") . '"'); ?> </div>
</div>
