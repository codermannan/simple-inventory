...
<?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=quotes&view=email_quote&id=".$id, $attrib); ?>
...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input('subject', $this->lang->line("quote")." ".$this->lang->line("from")." ".SITE_NAME, 'class="span4" id="subject" pattern=".{2,255}" required="required" data-error="'.$this->lang->line("subject").' '.$this->lang->line("is_required").'"');?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
  <div class="controls"> <?php echo form_submit('submit', $this->lang->line("email_quote"), 'class="btn btn-primary"');?> </div>
</div>
<?php echo form_close();?> 
