...
<?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=inventories&view=email_inventory&id=".$id, $attrib); ?>
...
<div class="control-group">
  ...
  <div class="controls"> <input type="email" name="to" id="to" class="span4" required="required" data-error="<?php echo $this->lang->line("email_address").' '.$this->lang->line("is_required"); ?>" /> </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input($subject, '', 'class="span4" id="subject" pattern=".{2,255}" required="required" data-error="'.$this->lang->line("subject").' '.$this->lang->line("is_required").'"');?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
  <div class="controls"> <?php echo form_submit('submit', $this->lang->line("email_inventory"), 'id="note" class="btn btn-primary"');?> </div>
</div>
<?php echo form_close();?> 
