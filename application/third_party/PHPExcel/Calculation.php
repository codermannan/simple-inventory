...
class PHPExcel_Calculation {
	 ...
	 *		If true, then a employee error will be triggered
	...
	public function setLocale($locale = 'en_us') {
		...
		if (in_array($language,self::$_validLocaleLanguages)) {
			...
			//	Default is English, if employee isn't requesting english, then read the necessary data from the locale files
			if ($locale != 'en_us') {
