...
return $("label[for='" + jElt.attr("id") + "']");
	...
	if (jElt.attr('type') == 'chosen' || jElt.attr('type') == 'select') {
...
var jDiv = $("<i></i>");
jDiv.text(jElt.attr('data-error'));
$(".main-content").one().prepend("<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>"+ jDiv.html() +"</div>");
}
